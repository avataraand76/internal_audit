...
const ImageHandler = forwardRef(({ onImageCapture, onImageUpload }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    getImages: () => {
      const imageFiles = images.map((image) => {
        ...
        // For uploaded files, create a new File object
        return new File([image.file], image.name, { type: image.file.type });
      });
      return imageFiles;
    },
    clearImages: () => {
